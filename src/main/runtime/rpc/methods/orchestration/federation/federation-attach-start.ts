...
import type { prepareFederationAttachmentWorkerStart } from '../worker/worker-start-validation'

type FederatedLaunch = ReturnType<typeof prepareFederationAttachmentWorkerStart>['launch']

export async function completeFederatedAttachStart(args: {
  runtime: OrcaRuntimeService
  db: OrchestrationDb
  params: FederationAttachStartInput
  createsWorktree: boolean
  agent: TuiAgent | undefined
  launch: FederatedLaunch
  ...
  try {
    ...
    const capability = db.prepareRemoteAttachmentAuthority({
      ...
      hostScope:
        ...
        authority.hostScope
          ? JSON.stringify(authority.hostScope)
          : null,
